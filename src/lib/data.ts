...
export async function getAboutData(): Promise<AboutData> {
  ...
  if (!data) {
    const defaultData = {
      ...
      paragraphs: [
        'Nascida e criada em Recife, <strong>Cássia Moretti</strong> sempre teve a arte como parte essencial de sua vida. Aos 10 anos, iniciou seus estudos na Academia Brasileira de Arte (ABRA), onde, ao longo de oito anos, se especializou em diversas técnicas, como desenho, pintura, xilogravura e fotografia.',
        ...
        'Atualmente, o escritório está localizado na zona sul de Recife e conta com uma equipe de mais de 10 colaboradores, atuando em projetos residenciais, comerciais e corporativos. Sempre inovando e transformando espaços, Cássia segue inspirando pessoas por meio de seu trabalho e sua trajetória, unindo arte, arquitetura e comunicação.',
      ],
    };
